...
axios.post("https://upskilling-egypt.com:443/api/v1/Recipe/",addFormData,{headers:{Authorization:`Bearer ${localStorage.getItem("adminToken")}`}}).then((response)=>{
  ...
  const updateRecipe=(data)=>{
    axios.put(`https://upskilling-egypt.com:443/api/v1/Recipe/:id`,data,{headers:{Authorization:`Bearer ${localStorage.getItem("adminToken")}`}}).then((response)=>
    {
  ...
  return (
   ...
   <>
    ...
    <form onSubmit={handleSubmit(updateRecipe)}>
            ...
            <div className="form-group">
              <input type="file"{...register("recipeImage")} />
              <img src={`https://upskilling-egypt.com:443`+recipe?.imagePath} alt="" />
            </div>
